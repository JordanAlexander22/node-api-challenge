...
Middleware and creating Endpoints

- [x] Describe Middleware?

A function that is in the file that can be used over and over again, in this project I used them to validate data and keep code cleaner.

- [x] Describe a Resource?

Resource is a RESTful subset of Endpoint.

- [x] What can the API return to help clients know if a request was successful? either a 200 or 201

- [x] How can we partition our application into sub-applications?
By making an index file and a server file with endpoints
